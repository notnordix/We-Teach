  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4">
      ...
      <a
        ...
        className="bg-wet-blue text-white p-3 rounded-full shadow-lg hover:bg-blue-700 transition-colors flex items-center justify-center group"
        aria-label="Appeler"
      >
      ...
      >
        ...
        <span className="absolute right-full mr-3 bg-green-500 text-white py-1 px-3 rounded text-sm whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          WhatsApp
        </span>
      </a>
    </div>
